...
(function() {
  var add_dot, data, generate_dots, get_date_array, get_nth_key, get_point, get_point_string, get_points, get_user_array, get_x_position, get_y_position, graph_height, graph_width, initialize_graph, keys, load_day_report, load_most_recent, maxim, values, x_space_between_points, y_space_between_points,
  ...
  generate_dots = function(svg, data) {
    ...
    _results = [];
    for (i = _i = 0, _ref = (values(data)).length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
      _results.push(add_dot(svg, i, data));
    }
    return _results;
  };
